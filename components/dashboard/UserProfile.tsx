    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-1 bg-white/5 border border-white/10 rounded-xl p-6 flex flex-col items-center text-center">
                ...
                <p className="text-accent1 font-medium mb-4">{user.role} @ {user.university}</p>

                <div className="flex gap-2 mb-6">
                    <button className="p-2 bg-white/10 rounded-full hover:bg-[#0077b5] hover:text-white transition-colors">
                        <Linkedin className="w-4 h-4" />
                    </button>
                    <button className="p-2 bg-white/10 rounded-full hover:bg-white hover:text-black transition-colors">
