...
import { Plus, Users, Calendar, TrendingUp, LayoutDashboard, Settings, Handshake } from "lucide-react";
                ...
                <div className="md:col-span-2 bg-[#111] border border-white/10 rounded-2xl p-6 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex gap-3">
                            <button
                                onClick={onManage}
                                className="flex-1 px-4 py-3 bg-white/10 hover:bg-white/20 rounded-xl font-bold text-sm text-white transition-colors"
                            >
                                Manage Event
                            </button>
                            <button
