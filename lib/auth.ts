...
export function normalizeRole(role: string): UserRole {
    ...
    if (normalized === "Participant" || normalized === "Organizer" || normalized === "Sponsor" || normalized === "Recruiter" || normalized === "Admin") {
...
export const RolePermissions = {
    // General permissions
    canViewEvents: (role: UserRole | null) => hasPermission(role, ["Participant", "Organizer", "Sponsor", "Recruiter", "Admin"]),
    canViewLeaderboard: (role: UserRole | null) => hasPermission(role, ["Participant", "Organizer", "Sponsor", "Recruiter", "Admin"]),
