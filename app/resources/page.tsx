...
export default function ResourcesPage() {
    ...
    useEffect(() => {
        // Always initialize with latest dummy data
    ...
    // Get current subjects based on selected domain
    const currentSubjects = selectedDomain === "All" ? [] : (COMPETITION_DOMAINS[selectedDomain as keyof typeof COMPETITION_DOMAINS] || []);
    ...
    return (
        <div className="min-h-screen bg-black selection:bg-accent1/30">
            ...
            <div className="pt-24 pb-12 max-w-7xl mx-auto px-6">
                ...
                <div className="mb-6">
                    <DomainDropdown
                        domains={Object.keys(COMPETITION_DOMAINS)}
                        selected={selectedDomain}
                        onSelect={setSelectedDomain}
                        resourceCounts={Object.keys(COMPETITION_DOMAINS).reduce((acc, domain) => {
                            acc[domain] = domain === "All"
                                ? resources.length
                                : resources.filter(r => r.domain === domain).length;
                            return acc;
