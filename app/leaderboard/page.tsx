...
import { DETAILED_EVENTS } from "@/constants/eventData";
import { motion } from "framer-motion";
import { Search, Trophy, Calendar, Users, ArrowRight, Dot } from "lucide-react";
...
export default function LeaderboardPage() {
    ...
    const filteredEvents = DETAILED_EVENTS.filter(e =>
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center gap-4 text-gray-400 text-xs font-medium mb-6">
                                    ...
                                    <span className="flex items-center gap-1.5">
                                        <Users className="w-3.5 h-3.5" /> {event.participants.toLocaleString()}
                                    </span>
                                </div>
